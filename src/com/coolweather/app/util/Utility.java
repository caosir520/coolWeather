	...
	*/
	...
	/*public static void handleWeatherResponse(Context context,String response ){
		try {
			...
			Log.d("Weather", "shibai");
			e.printStackTrace();
		}
	}*/
	/*
	 * 讲服务器返回的所有天气信息存储到SharePreferences文件里
	 * */
	/*public static void saveWeatherInfo(Context context, String cityName,
			String weatherCode, String temp1, String temp2, String weatherDesp, String
			publishTime){
		//SharedPreference 的使用方法
		//1.获取一个SharedPreferences 对象，
		//2.用SharedPreference对象的Edit（）方法获取一个SharePreference.Editor对象
